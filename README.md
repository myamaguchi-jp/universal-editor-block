...
## Environments
- Preview: https://main--universal-editor-block--myamaguchi-jp.aem.page/
- Live: https://main--universal-editor-block--myamaguchi-jp.aem.live/
...
1. Open the `universal-editor-block` directory in your favorite IDE and start coding :)